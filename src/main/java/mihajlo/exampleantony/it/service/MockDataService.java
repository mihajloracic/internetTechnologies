...
public class MockDataService {
    ...
    public void populateData()  {
        ...
        if(userRepositoryForTest.findByUsername("m1").size() == 0){
			...
			User u4 = userRepositoryForTest.save( new User("Tomas","$2a$10$4UQxFJ0Txc3JJAlq6i7hgeRNQN5OoSpTt5NMKHKbPpeXdjWJDd4IO","m4444.rac@gmail.com","Tomas","Ratru","https://scontent.fvno3-1.fna.fbcdn.net/v/t1.0-1/c0.1.160.160/p160x160/32264435_995036600662761_6341740115596935168_n.jpg?_nc_cat=0&oh=0e8d9a0499bacfa1f624577dae11053c&oe=5B7F081C"));
...
=======
>>>>>>> 018dbb5dd98cd4ce6543d8be792d72d4d47e92c4
